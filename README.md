...
- **Read-only:** `list_trips`, `get_trip`, `list_places`, `list_sections`, `get_flights`, `get_trip_sections`, `search_places`, `search_restaurants`, `search_places_wanderlog`, `search_hotels`, `get_place_details`, `get_flight_stops`, `get_like_count`, `list_trip_invites`, `get_me`, `get_user_profile`, `get_notifications`, `get_notification_settings`, `get_user_emails`, `autocomplete_users`, `is_username_taken`, `get_feed_home`, `get_feed_recent`, `get_feed_friends`, `get_trip_history`, `browse_guides`, `search_geos`, `get_view_only_journal`, `get_trip_expenses_csv`, `get_trip_distinction`, `get_trip_images`, `get_all_airlines`, `autocomplete_airports`, `get_hotel_rates`, `get_global_config`
- **Write-gated (need `--enable-write`):** `add_place`, `remove_place`, `move_place`, `reorder_places`, `update_place_notes`, `update_place_visit_time`, `add_flight`, `update_flight`, `delete_flight`, `add_lodging`, `update_lodging`, `delete_lodging`, `delete_itinerary_block`, `set_trip_budget`, `add_trip_expense`, `update_trip_expense`, `delete_trip_expense`, `create_trip`, `delete_trip`, `delete_trips`, `restore_trip`, `copy_trip`, `update_trip`, `like_trip`, `send_trip_invites`, `mark_notifications_read`, `set_user_kv`, `register_trip_view`, `create_guide_from_trip`, `export_trip`, `autofill_day`, `add_checklist_items`, `toggle_checklist_item`, `add_collaborator`, `remove_collaborator`, `get_or_create_share_key`
