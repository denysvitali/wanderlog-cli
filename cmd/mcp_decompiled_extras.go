...
// registerDecompiledExtras adds MCP tools for the geo, directions,
// recommendations, places, placesAPI, chat, and miscellaneous endpoints
// discovered in the decompiled bundle.
func registerDecompiledExtras(s *server.MCPServer, readOnly bool) {
	// === Geo (read-only) ===
