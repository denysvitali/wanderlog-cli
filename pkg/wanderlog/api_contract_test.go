...
func TestAPIRequestContracts(t *testing.T) {
	...
	for _, contract := range contracts {
		...
		t.Run(contract.Name, func(t *testing.T) {
			if !hasDecompilerEndpoint(decompiledEndpoints, contract.DecompilerPath) {
				t.Fatalf("decompiled endpoint %q not found", contract.DecompilerPath)
			}
...
func loadDecompilerEndpoints(t *testing.T) map[string]bool {
	t.Helper()
...
func hasDecompilerEndpoint(endpoints map[string]bool, expected string) bool {
